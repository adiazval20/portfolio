    ...
    <div>
      ...
      <div className="xl:mx-70 lg:mx-40 md:mx-20 md:flex my-10">
        <div className="big-skills-item">
          ...
          <h1>Data Access</h1>
          <p>Experienced in OOP, Design Patterns and DDD.
          </p>
          <hr />
          <h2>Core expertise</h2>
          <p>NET, C#, Linq, Entity Framework, Razor.</p>
        </div>
        <div className="big-skills-item">
          <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
          ...
          <h1>Backend</h1>
          <p>Experienced in OOP, Design Patterns and DDD.</p>
          <hr />
          <h2>Core expertise</h2>
          <p>NET, C#, Linq, Entity Framework, Razor.</p>
        </div>
      ...
      <div className="xl:mx-70">
        <Disclosure as="div" className="experience-item">
          ...
          <DisclosurePanel className="experience-body">
            <ul>
              <li>Led Azure DevOps implementation by designing and configuring automated CI/CD pipelines. This implementation reduced manual integration effort across all environments.</li>
              <li>Provided technical consulting for the STARSTrack product, leading front-end and backend system implementations, and cross-functional requirements definition.</li>
              <li>Led the software and infrastructure architecture for multiple teams, implementing best practices and design patterns that enhanced application reliability, maintainability, and scalability.</li>
            </ul>
          </DisclosurePanel>
        </Disclosure>
        <Disclosure as="div" className="experience-item">
          <DisclosureButton className="experience-item-title">
            <div className="item-title-left">
              <div>KAITS CONSULTING</div>
              <div>Senior .NET Developer</div>
            </div>
            <div className="item-title-right">
              <div>Lima, Perú</div>
              <div>08/2021 - 08/2022</div>
            </div>
          </DisclosureButton>
          <DisclosurePanel className="experience-body">
            <ul>
      ...
      <h2 className="mt-15 mb-8 text-6xl font-semibold text-center">Projects</h2>
      <div className="md:mx-30 md:flex">
        <div className="project-item">
          <img src="projects/project-1.png" />
        ...
        <div className="project-item">
          <img src="projects/project-2.jpg" />
          <div className="project-body">
            <h1>Portfolio</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          </div>
